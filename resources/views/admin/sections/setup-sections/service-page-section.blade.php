...
@section('content')
                                    ...
                                    <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif"
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.textarea', [
                                                ...
                                                'value' => old(
                                                    $item->code . '_desc',
                                                    $data->value->language->$lang_code->desc ?? ''),
                                            ])
                                        </div>
                                    </div>
                                @endforeach
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#service-page-item-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i>
                        {{ __('Add Item') }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.add-service-page-item')

    {{-- Why choose us edit modal --}}
    <div id="service-page-item-edit" class="mfp-hide large">
...
@push('script')
    ...
    <script>
        openModalWhenError("service-page-item-add", "#service-page-item-add");
        openModalWhenError("service-page-item-edit", "#service-page-item-edit");
        ...
        $(".edit-modal-button").click(function() {
            ...
            var editModal = $("#service-page-item-edit");

            editModal.find("form").first().find("input[name=target]").val(oldData.id);

            $.each(languages, function(index, item) {
                editModal.find("textarea[name=" + item.code + "_description_edit]").val(oldData.language[
                    item.code]?.description);
            });
            openModalBySelector("#service-page-item-edit");
