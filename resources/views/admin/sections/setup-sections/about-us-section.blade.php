...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#about-us-item-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i>
                        {{ __('Add Item') }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.add-about-us-item')

    {{-- Why choose us edit modal --}}
    <div id="about-us-item-edit" class="mfp-hide large">
