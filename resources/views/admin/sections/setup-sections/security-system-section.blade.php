...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#security-system-item-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i>
                        {{ __('Add Item') }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.add-security-system-item')

    {{-- Why choose us edit modal --}}
    <div id="security-system-item-edit" class="mfp-hide large">
...
@push('script')
    ...
    <script>
        openModalWhenError("security-system-item-add", "#security-system-item-add");
        openModalWhenError("security-system-item-edit", "#security-system-item-edit");
        ...
        $(".edit-modal-button").click(function() {
            ...
            var editModal = $("#security-system-item-edit");
            ...
            openModalBySelector("#security-system-item-edit");
