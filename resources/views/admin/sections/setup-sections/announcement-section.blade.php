                                ...
                                <div class="dashboard-content">
                                    ...
                                    <div class="right">
                                        <div class="chart" id="chart6"
                                            data-percent="{{ get_percentage_from_two_number($total_categories, $total_categories) }}">
                                            <span>{{ get_percentage_from_two_number($total_categories, $total_categories) }}%</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="dashboard-content">
                                    ...
                                    <div class="right">
                                        <div class="chart" id="chart7"
                                            data-percent="{{ get_percentage_from_two_number($total_categories, $active_categories) }}">
                                            <span>{{ get_percentage_from_two_number($total_categories, $active_categories) }}%</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="dashboard-content">
                                    ...
                                    <div class="right">
                                        <div class="chart" id="chart8"
                                            data-percent="{{ get_percentage_from_two_number($total_announcements, $total_announcements) }}">
                                            <span>{{ get_percentage_from_two_number($total_announcements, $total_announcements) }}%</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="dashboard-content">
                                    ...
                                    <div class="right">
                                        <div class="chart" id="chart9"
                                            data-percent="{{ get_percentage_from_two_number($total_announcements, $active_announcements) }}">
                                            <span>{{ get_percentage_from_two_number($total_announcements, $active_announcements) }}%</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
