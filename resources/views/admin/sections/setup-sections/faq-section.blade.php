        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#faq-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i>
                        {{ __('Add Item ') }}</a>
                </div>
            </div>
                                    ...
                                    <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif"
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.input', [
                                                ...
                                                'value' => old(
                                                    $lang_code . '_question_edit',
                                                    $data->value->language->$lang_code->question ?? ''),
                                            ])
                                        </div>
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.textarea', [
                                                ...
                                                'value' => old(
                                                    $lang_code . '_answer_edit',
                                                    $data->value->language->$lang_code->answer ?? ''),
                                            ])
                                        </div>
...
@push('script')
    <script>
        ...
        $(".edit-modal-button").click(function() {
            ...
            editModal.find("input[name=" + default_language + "_question_edit]").val(oldData.language[
                default_language].question);
            editModal.find("textarea[name=" + default_language + "_answer_edit]").val(oldData.language[
                default_language].answer);
            $.each(languages, function(index, item) {
                editModal.find("input[name=" + item.code + "_question_edit]").val(oldData.language[item
                    .code]?.question);
                editModal.find("textarea[name=" + item.code + "_answer_edit]").val(oldData.language[item
                    .code]?.answer);
