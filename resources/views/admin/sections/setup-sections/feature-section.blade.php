...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#feature-item-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i>
                        {{ __('Add Item') }}</a>
                </div>
            </div>
    ...
    <div id="feature-item-edit" class="mfp-hide large">
...
@push('script')
    ...
    <script>
        openModalWhenError("feature-item-add", "#feature-item-add");
        openModalWhenError("feature-item-edit", "#feature-item-edit");
        ...
        $(".edit-modal-button").click(function() {
            ...
            var editModal = $("#feature-item-edit");
            ...
            openModalBySelector("#feature-item-edit");
