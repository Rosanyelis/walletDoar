...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#why-choose-us-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i>
                        {{ __('Add Item') }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.add-why-choose-us')

    {{-- Why choose us edit modal --}}
    <div id="why-choose-us-item-edit" class="mfp-hide large">
...
@push('script')
    ...
    <script>
        openModalWhenError("why-choose-us-add", "#why-choose-us-add");
        openModalWhenError("why-choose-us-item-edit", "#why-choose-us-item-edit");
        ...
        $(".edit-modal-button").click(function() {
            ...
            var editModal = $("#why-choose-us-item-edit");
            ...
            openModalBySelector("#why-choose-us-item-edit");
