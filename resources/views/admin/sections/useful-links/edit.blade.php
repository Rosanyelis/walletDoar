...
@section('content')
    <div class="custom-card">
        ...
        <div class="card-body">
            <form class="card-form" action="{{ setRoute('admin.useful.links.update', $useful_link->slug) }}" method="POST"
                                    ...
                                    <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif"
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.input', [
                                                ...
                                                'value' => old(
                                                    $lang_code . '_title',
                                                    $useful_link->title?->language?->$lang_code?->title ?? ''),
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.input-text-rich', [
                                                ...
                                                'value' => old(
                                                    $lang_code . '_content',
                                                    $useful_link->content?->language?->$lang_code?->content ?? ''),
                                            ])
                                        </div>
                                    </div>
                                @endforeach
