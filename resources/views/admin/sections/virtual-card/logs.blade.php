                    ...
                    <tbody>
                        @forelse ($transactions  as $key => $item)
                            ...
                            <tr>
                                ...
                                <td>{{ @$item->remark }}</td>
                                <td>{{ get_amount($item->request_amount,get_default_currency_code(),get_wallet_precision()) }}</td>
                                <td>{{ get_amount($item->charge->total_charge,$item->user_wallet->currency->code,get_wallet_precision()) }}</td>
                                <td>{{ get_amount($item->request_amount,$item->details->card_info->currency??get_default_currency_code(),get_wallet_precision()) }}</td>
                                <td>
                                    @php
