                        ...
                        <div class="preview-list-wrapper">
                            <div class="preview-list-item">
                                ...
                                <div class="preview-list-right">
                                    <span class="request-amount">{{ get_amount(@$temp_data->data->amount->requested_amount,@$temp_data->data->amount->receiver_cur_code,4 )}}</span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
                                ...
                                <div class="preview-list-right">
                                    <span class="request-amount">{{ __("1") }} {{ $temp_data->data->amount->receiver_cur_code }} =  {{ get_amount(@$temp_data->data->amount->exchange_rate, @$temp_data->data->amount->sender_cur_code,4 )}}</span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
