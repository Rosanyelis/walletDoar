...
<div class="row mt-20 mb-20-none">
    <div class="col-xl-7 col-lg-7 mb-20">
        <div class="custom-card mt-10">
            ...
            <div class="card-body">
                <form class="card-form" action="{{ setRoute("user.add.money.manual.submit",$token) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row"> 
                ...
                <div class="preview-list-wrapper">
                    <div class="preview-list-item">
                        ...
                        <div class="preview-list-right">
                            <span class="request-amount">{{ number_format(@$amount->requested_amount,$digitShow )}} {{ $amount->receiver_cur_code }}</span>
                        </div>
                    </div>
                    <div class="preview-list-item">
                        <div class="preview-list-left">
                        ...
                        <div class="preview-list-right">
                            <span class="request-amount">{{ __("1") }} {{ $amount->receiver_cur_code }} =  {{ number_format(@$amount->exchange_rate,$digitShow )}} {{ @$amount->sender_cur_code }}</span>
                        </div>
                    </div>
                    <div class="preview-list-item">
                        <div class="preview-list-left">
                        ...
                        <div class="preview-list-right">
                            <span class="conversion">{{ number_format(@$amount->requested_amount*$amount->exchange_rate,$digitShow )}} {{ @$amount->sender_cur_code }}</span>
                        </div>
                    </div>
                    <div class="preview-list-item">
                        <div class="preview-list-left">
                        ...
                        <div class="preview-list-right">
                            <span class="fees">{{ number_format(@$amount->total_charge,$digitShow )}} {{ @$amount->sender_cur_code }}</span>
                        </div>
                    </div>
                    <div class="preview-list-item">
                        <div class="preview-list-left">
                        ...
                        <div class="preview-list-right">
                            <span class="text--warning last">{{ number_format(@$amount->total_amount,$digitShow )}} {{ @$amount->sender_cur_code }}</span>
                        </div>
                    </div>
                </div>
            </div>
