            ...
            <div class="custom-card mt-10">
                <div class="dashboard-header-wrapper">
                    ...
                    <div class="account-delate">
                        <button class="btn--base btn" data-bs-toggle="modal"
                            data-bs-target="#delateModal">{{ __('Delate Account') }}</button>
                    </div>
                </div>
                            ...
                            <div class="preview-thumb profile-wallpaper">
                                <div class="avatar-preview">
                                    <div class="profilePicPreview bg_img"
                                        data-background="{{ get_image('frontend/images/element/profile-thumb.webp') }}">
                                    </div>
                                </div>
                            </div>
                    ...
                    <form class="card-form" action="{{ setRoute('user.profile.password.update') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 form-group show_hide_password">
                                ...
                                <a href="javascript:void(0)" class="show-pass field-icon"><i class="fa fa-eye-slash"
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <p>{{ __('If you do not think you will use') }} <span
                        ...
                        {{ __('again and like your account deleted. Keep in mind you will not be able to reactivate your account or retrieve any of the content or information you have added. If you would still like your account deleted, click “Delete Account”') }}.?
                    </p>
