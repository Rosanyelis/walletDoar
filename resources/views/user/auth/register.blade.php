                        ...
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-10">
                                ...
                                <div class="personal-account ptb-30 select-account" data-select-target="1"
                                    style="display: none;">
                                    <form action="{{ setRoute('user.register.submit') }}" class="account-form"
                                        method="POST">
                                        @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 form-group">
                                                <select name="country"
                                                    class="form--control select2-auto-tokenize country-select"
                                                    data-old="{{ old('country', $user_country) }}">
                                            ...
                                            <div class="col-lg-12 form-group">
                                                <div class="custom-check-group mb-0">
                                                    ...
                                                    <label for="level-1"
                                                        ...
                                                        <a href="{{ route('page.view', 'terms-condition') }}"
                                                            class="text--base">{{ __('Terms Condition') }}</a>
                                                        <a class="text--base">&</a>
                                                        <a href="{{ route('page.view', 'privacy-policy') }}"
                                                            class="text--base">{{ __('Privacy Policy') }}</a>
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 text-center">
                                                <div class="account-item mt-10">
                                                    <label>{{ __('Already Have An Account?') }} <a
                                                            ...
                                                            class="text--base">{{ _('Login Now') }}</a></label>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
