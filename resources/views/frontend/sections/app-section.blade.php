        ...
        <div class="app-section-title pb-40">
            <div class="row align-items-center mb-40-none">
                <div class="col-lg-7 mb-40">
                    <div class="app-title">
                        <h2 class="titl">
                            {{ @$app->value->language->$defualt->heading ?? @$app->value->language->$en->heading }}</h2>
                    </div>
                        ...
                        @foreach ($app->value->items ?? [] as $key => $item)
                            <a href="{{ @$item->link ?? '' }}" class="app-btn">
                                ...
                                <div class="content">
                                    ...
                                    <h5 class="title">
                                        {{ @$item->language->$defualt->sub_title ?? @$item->language->$en->sub_title }}
                                    </h5>
                                </div>
                                <div class="icon">
                                    <img src="{{ get_image('frontend/images/element/qr-icon.webp') }}" alt="element">
                                </div>
                            </a>
                        @endforeach
                    </div>
