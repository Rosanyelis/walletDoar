...
use App\Http\Controllers\Api\V1\User\VirtualCardController;
...
Route::prefix("user")->name("api.user.")->group(function(){
    ...
    Route::controller(ReceipientController::class)->middleware('kyc.verification.api')->prefix('recipient')->name('receipient.')->group(function(){
      ...
      //virtual card
    Route::controller(VirtualCardController::class)->prefix('virtual-card')->middleware(['kyc.verification.guard'])->group(function () {
        Route::get('statistics', 'statistics');
        Route::get('customer/info', 'customerInfo');
        Route::post('create/customer', 'createCustomer')->name('create.customer');
        Route::get('edit/customer/info', 'editCustomerInfo');
        Route::post('update/customer', 'updateCustomer')->name('update.customer');
        Route::post('issue', 'cardIssue');
        Route::get('details', 'cardDetails');
        Route::post('deposit', 'cardDeposit');
        Route::post('withdraw', 'cardWithdraw');
        Route::post('change/status', 'freezeUnfreeze');
        Route::post('close', 'closeCard');
