...
use App\Http\Controllers\Admin\VirtualCardLogController;
...
Route::name('admin.')->group(function () {
    ...
    Route::middleware(['web', 'auth:admin', 'app.mode', 'admin.role.guard'])->group(function () {
        ...
        Route::controller(VirtualCardController::class)->prefix('virtual-card')->name('virtual.card.')->group(function () {
            ...
            Route::put('providers/update', 'updateProvider')->name('provider.update');
            Route::put('providers/currency/update', 'updateProviderCurrency')->name('providers.currency.update');
            Route::put('providers/currency/update/status', 'currencyUpdate')->name('providers.currency.status.update');
        });
        // virtual card logs
        Route::controller(VirtualCardLogController::class)->prefix('virtual-card-log')->name('virtual.card.log.')->group(function () {
            Route::get('index', 'index')->name('index');
        ...
        // Storage Settings
        Route::controller(StorageSettingsController::class)->prefix('storage-settings')->name('storage.settings.')->group(function () {
