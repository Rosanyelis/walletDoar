...
class SiteController extends Controller
{
    ...
    public function aboutUs() {
        ...
        return view('frontend.pages.about-us', compact('page_title','page_section','about'));
    }
    ...
    public function webJournal()
    {
        ...
        $blogs = Announcement::where('status',1)->orderByDesc("id")->take(6)->get();
        ...
        return view('frontend.pages.web-journal', compact('page_title','blogs','page_section'));
    }
    ...
    public function faq(){
        $page_title = "Faq";
        $page_section = SetupPage::where('slug', 'faq')->with(['sections' => function($q){
            $q->where('status',true);
        }])->first();
        return view('frontend.pages.faq',compact('page_title','page_section'));
    }
