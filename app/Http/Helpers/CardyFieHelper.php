...
class CardyFieHelper{
    ...
    public function setConfig()
    {
        ...
        if($api->mode == GlobalConst::LIVE){
            $base_url = $api->production_url;
        }else{
            $base_url = $api->sandbox_url;
        }
        $config['public_key'] = $api->public_key;
        $config['secret_key'] = $api->secret_key;
    ...
    public function createCustomer(array $data)
    {
        ...
        $form_data = [
            ...
            "id_type"        => $data['identity_type']      ?? $data['id_type'] ?? null,
            "id_number"      => $data['identity_number']    ?? $data['id_number'] ?? null,
    ...
    public function issuesCard(array $data)
    {
     ...
     public function issueCard(array $data)
    {
        ...
        $form_data = [
            ...
            "card_currency" => $data['card_currency']              ?? null,
