...
class CardWithdrawNotification extends Notification implements ShouldQueue
{
    use Queueable;
public $data;
    /**
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->line(__("Your virtual card withdraw successful"))
            ...
            ->line(__("Receive Amount") . ": " . $data->card_amount)
