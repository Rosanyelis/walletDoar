...
class Transaction extends Model
{
    ...
    const TYPE_CARD_ISSUE = "CARD-ISSUE";
    const TYPE_CARD_DEPOSIT = "CARD-DEPOSIT";
    const TYPE_CARD_WITHDRAW = "CARD-WITHDRAW";
    ...
    public function getStringStatusAttribute() {
        ...
        }else if($status == PaymentGatewayConst::STATUS_CONFIRM_PAYMENT) {
            $data = [
                'class'     => "badge badge--success",
                'value'     => __("Confirm Payment"),
            ];
        }else if($status == PaymentGatewayConst::STATUS_CANCEL) {
            $data = [
                'class'     => "badge badge--danger",
                'value'     => __("Cancel"),
            ];
    ...
    public function scopeAddMoney($query) {
     ...
     public function scopeVirtualCard($query) {
        return $query->whereIn('type', [self::TYPE_CARD_ISSUE, self::TYPE_CARD_DEPOSIT, self::TYPE_CARD_WITHDRAW]);
    }
